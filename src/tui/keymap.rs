...
impl Action {
    ...
    pub fn name(self) -> String {
        match self {
            ...
            Action::SqlOpen => "sql.open".into(),
            Action::SqlExec => "sql.exec".into(),
            Action::SqlCatalog => "sql.catalog".into(),
            Action::SqlHistory => "sql.history".into(),
            Action::SqlConnectionAdd => "sql.connection.add".into(),
            Action::SqlConnectionEdit => "sql.connection.edit".into(),
            Action::SqlConnectionList => "sql.connection.list".into(),
            Action::SqlConnectionTest => "sql.connection.test".into(),
            Action::SqlConnectionForget => "sql.connection.forget".into(),
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            Action::Duplicate => "복제",
            Action::SqlOpen => "SQL 작업공간 열기",
            Action::SqlExec => "SQL 실행",
            Action::SqlCatalog => "SQL catalog",
            Action::SqlHistory => "SQL query history",
            Action::SqlConnectionAdd => "SQL connection 추가",
            Action::SqlConnectionEdit => "SQL connection 수정",
            Action::SqlConnectionList => "SQL connection 목록",
            Action::SqlConnectionTest => "SQL connection 검사",
            Action::SqlConnectionForget => "SQL connection 삭제",
